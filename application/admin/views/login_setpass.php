...
<div id="body-main">
	...
	<div style="text-align:center;color:#0088cc; font-size:14px; margin-top:400px;"><a href="http://adomikao.com/" target="_blank"> <?php echo lang('company') ?> </a> 客服热线：<?php echo lang('404');?> </div>
</div>

<div id="body-footer">
	<div class="container-fluid">
		<p class="muted credit"> Power by  <a href="http://adomikao.com/"> &copy; <?php echo lang('company') ?></a> .</p>
	</div>
</div>
