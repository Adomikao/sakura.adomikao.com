...
<div class="boxed">
    <h3><i class="fa fa-pencil"></i> <?php echo $title;
        echo lang('edit'); ?> </h3>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="nickname" name="nickname"
                       value="<?php echo set_value('nickname', $it['nickname']) ?>">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class='btn-group btn-switch'>
                        <a href="#" data-value="1"
                           class="btn <?php echo set_switch('status', 1, $it['status'], 'btn-primary') ?>"> 正常 </a>
                        <a href="#" data-value="0"
                           class="btn <?php echo set_switch('status', 0, $it['status'], 'btn-primary') ?>"> 禁用</a>
                    </div>
                    <input type="hidden" id="status" name="status"
                           value="<?php echo set_value('status', $it['status']) ?>">
                </div>
            </div>
        <?php endif ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="phone" name="phone"
                               value="<?php echo set_value('phone', $it['phone']) ?>">
                        <span class="help-inline"></span>
                    </div>
                </div>
                <div class="control-group">
