...
<div class="photos-list img-list js-goal pull-left" data-id="{% =it.id %}" data-thumb="{% =it.thumb %}" >
	...
	<div class="img-list-action">
		...
		{% } %}
		<a href="#" class="pull-center btn-seo" data-seo="{% =it.id %}" title="注释" ><i class="fa fa-info-circle"></i></a>
...
<div class="img-list js-goal pull-left" data-id="{% =list[i].id %}" data-thumb="{% =list[i].thumb %}" >
	...
	<div class="img-list-action">
		...
		{% } %}
		<a href="#" class="pull-center btn-seo" data-seo="{% =list[i].id %}" title="注释" ><i class="fa fa-info-circle"></i></a>
...
<!--		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label" for="js-upload-seo-text">注释</label>
			<div class="controls">
