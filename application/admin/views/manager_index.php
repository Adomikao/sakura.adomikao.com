            ...
            <table class="table table-striped table-hover select-list">
                ...
                <?php foreach ($list as $v): ?>
                    <tr>
                        ...
                        <td> <?php echo mdate("%Y/%m/%d %h:%i:%s", $v['login_time']) ?></td>
                        <td>
                            <div class="btn-group">
...
<?php // 普通帐号显示信息
    ...
    <?php
    $user = $this->mmger->get_one($_SESSION['mid']);
    ...
    <div class="boxed span6">
        <div class="boxed-inner">
            ...
            <div style="padding-left:50px;">
                <p>
                <div class="btn-group">
                    <a href="<?php echo site_url('manager/passwd'); ?>" class='btn btn-primary'> <i
                                class="icon-pencil icon-white"></i> 修改密码 </a>
                </div>
                <div class="btn-group">
                    <a href="<?php echo site_url('manager/edit') . '/' . $_SESSION['mid']; ?>"
                       class='btn btn-primary'> <i class="icon-pencil icon-white"></i> 修改帐号 </a>
                </div>
                </p>
            </div>
        </div>
