...
class Log_model extends MY_Model
{
    ...
    {
        $this->db->select('log.id,controller,url,category,message,mid,m.nickname as name,ip,timeline')->from('log')
            ->join('manager as m', 'm.id=log.mid', 'left')->limit($limit, $start);
        if ($order) {
