...
class Hashids
{
    ...
    const MIN_ALPHABET_LENGTH = 16;//9
    const SEP_DIV = 3.5;
    const GUARD_DIV = 12;
...
//    private $_alphabet = '_abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890';
    private $_alphabet = '_abcdefghijklmnopqrstuvwxyz1234567890';
